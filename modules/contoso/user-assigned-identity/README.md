# User Assigned Identities `[Microsoft.contoso/userassignedidentity]`
...
>**Note**: To reference the module, please use the following syntax `br:bicep/modules/contoso.user-assigned-identity:1.0.0`.
...
```bicep
module userAssignedIdentity 'br:bicep/modules/contoso.user-assigned-identity:1.0.0' = {
